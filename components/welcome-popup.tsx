            ...
            <div className="info-box flex-1 border border-inset border-[#808080] bg-[#ffffe0] p-[10px] text-black leading-[1.4]">
              <div className="info-content flex items-start gap-[10px]">
                ...
                <div className="info-text flex-1 leading-[1.4] text-xs">
                  ...
                  <p className="mt-3">
                    I'm Joel, a Computer Science student and aspiring Machine Learning Engineer. I'm also a huge fan of
                    retro tech, so I decided to create this portfolio based on <strong>Windows 95!</strong>. Thank you
                    for visiting, and enjoy the experience!
                  </p>
                </div>
              </div>
            </div>
